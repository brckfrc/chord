...
#!/bin/bash
# Chord Production Start Script
# Generated by setup-env.sh

set -e
cd "\$(dirname "\$0")/backend"

echo "Starting Chord Production..."
...
echo ""
echo "=========================================="
echo "  Chord Production is running!"
echo "=========================================="
echo ""
...
main() {
    ...
    if [ "$MODE" == "dev" ]; then
        ...
        echo "   - Set up SSL/TLS with Caddy or Nginx"
        echo "   - Keep .env file secure: chmod 600 backend/.env"
        echo ""
        echo "Useful commands:"
        echo "   - View logs: docker compose -f backend/docker-compose.prod.yml logs -f"
        echo "   - Restart API: docker compose -f backend/docker-compose.prod.yml restart api"
    fi
    echo ""
}
